...
def get_breakdown_items():
    ...
    # {"node": node_name, "type": "reference", "path": reference_path}
    # print "scene_objects:%s"%scene_objects

    substance_publish_template = "substancepainter_asset_textures_path_publish"
    template_obj =  app.tank.templates[substance_publish_template]

    print "substancepainter added..."
    ...
    for scene_object in scene_objects:
        ...
        # if filename is substancepainter files , do this:
        ...
        if "\\publish\\substancepainter\\" in file_name:
            ...
            sub_template = app.tank.template_from_path(folder_name)
            if sub_template ==template_obj:
                matching_template = sub_template
                _isSubstance = True

        if matching_template:

            if _isSubstance:
                fields = matching_template.get_fields(folder_name)
            else:
